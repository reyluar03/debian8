...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/reyluar18/debian8/master/screenfetch"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/reyluar18/debian8/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/reyluar18/debian8/master/badvpn-udpgw64"
fi
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/reyluar18/debian8/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/reyluar18/debian8/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/reyluar18/debian8/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://raw.githubusercontent.com/reyluar18/debian8/master/dropbear-2018.76.tar.bz2
...
# install vnstat gui
cd /home/vps/public_html/
wget https://raw.githubusercontent.com/reyluar18/debian8/master/vnstat_php_frontend-1.5.1.tar.gz
...
wget -O /etc/stunnel/stunnel.pem "https://raw.githubusercontent.com/reyluar18/debian8/master/updates/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/reyluar18/debian8/master/req/stunnel.conf"
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/reyluar18/debian8/master/issue.net"
...
cd
wget https://raw.githubusercontent.com/reyluar18/debian8/master/updates/install-premiumscript.sh -O - -o /dev/null|sh
